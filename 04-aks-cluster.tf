...
resource "azurerm_kubernetes_cluster" "aks_cluster" {
  name                = "aks-${var.product_name}-${var.environment}-${local.location_abbreviation}${var.postfix}"
  location            = azurerm_resource_group.main_rg.location
  resource_group_name = azurerm_resource_group.main_rg.name
  dns_prefix          = "aks-${var.product_name}-${var.environment}-${local.location_abbreviation}${var.postfix}"
